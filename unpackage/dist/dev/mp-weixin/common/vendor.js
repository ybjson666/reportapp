...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"report-app","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getContact = exports.showModal = exports.tranStamp = exports.formatTime = exports.reCalHeight = void 0;var reCalHeight = function reCalHeight() {
  setTimeout(function () {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = __webpack_require__(/*! ./config.js */ 13);

var baseData = {
  access_token: localStorage && localStorage.getItem('appToken') ? localStorage.getItem('appToken') : "" };var _default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.BASE_URL = void 0;var BASE_URL = "http://cs1.zbyj.top/index.php";exports.BASE_URL = BASE_URL;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.reg_email = exports.reg_pwd = exports.reg_phone = void 0;var reg_phone = /^1\d{10}$/;
//密码正则
exports.reg_phone = reg_phone;var reg_pwd = /^(?![a-zA-Z]+$)(?!\d+$)(?![\W_]+$)\S{8,16}$/;
//邮箱正则
exports.reg_pwd = reg_pwd;var reg_email = /^([a-zA-Z]|[0-9])(\w|\-)+@[a-zA-Z0-9]+\.([a-zA-Z]{2,4})$/;exports.reg_email = reg_email;
...
allData;exports.default = _default;
